...
<!--
                <li class="tabs-2" data-tab-name="resume"><span class="tabs-text">Замовлення</span></li>
                <li class="tabs-4" data-tab-name="contact"><span class="tabs-text">Доставки</span></li>
-->
              </ul>
              ...
              <div class="resp-tabs-container hor_1 tabs_scroll">
                ...
                <div class="fc-tab-1">
                  ...
                  <div class="home-container">
                    <div class="row">
                      <div class="col-md-6">
                          <iframe src="../../includes/b_self_table.php" width="850" height="305"></iframe>
                      </div>
                    </div>
                  </div>
			...
			<div class="about-container">
                    <div class="row">
                      <div class="col-md-12">
						...
						<form method="GET" action="../../includes/helpers/bself_edit.php" class="form"><br>
