...
?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
						...
						<form method="POST" action="../../includes/tio_add.php" class="form">
							...
							Знижка: <br>
							<input class="label-input" type="text" name="discount" value=""><br>
							Загальна сума:<br>
							<input class="label-input" type="text" name="total_price" value=""><br><br>
    ...
    ?>   </select><br><br>
							...
							<input class="label-input" type="text" name="quantity_of_tickets" value=""><br><br>
							Телефон покупця:<br> 
