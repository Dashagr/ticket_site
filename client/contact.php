		...
		<div class="row">
			...
			<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
            	<div class="header-thumb">
              		 <h1 class="wow fadeIn reviue-article" data-wow-delay="0.6s">Contact Us</h1>
              		 <h3 class="wow fadeInUp reviue-article" data-wow-delay="0.9s">Зв'яжіться з нами тут</h3>
           		</div>
			</div>
		...
		<div class="wow fadeInUp col-md-6 col-sm-12" data-wow-delay="1.6s">
			...
			<div class="contact-form">
				<form id="contact-form" method="post" action="#">
					<h2>Графік роботи офісу: </h2>
                <p class="time"> Пн:  10.00 - 18.00<br> 
                    ВТ:  10.00 - 18.00<br> 
                    Ср:  10.00 - 18.00<br>
                    Чт:  10.00 - 18.00<br>
                    Пт:  10.00 - 18.00<br>
			...
			<div class="col-md-4 col-sm-4">
				<div class="wow fadeInUp media" data-wow-delay="0.3s">
					...
					<div class="media-body">
						...
						<p class="align-left">+99 00 8877 6655</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4 col-sm-4">
				<div class="wow fadeInUp media" data-wow-delay="0.6s">
					...
					<div class="media-body">
						...
						<p class="align-left">hello@company.com</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4 col-sm-4">
				<div class="wow fadeInUp media" data-wow-delay="0.9s">
					...
					<div class="media-body">
						...
						<p class="align-left">123 New Street, Old Town<br>
